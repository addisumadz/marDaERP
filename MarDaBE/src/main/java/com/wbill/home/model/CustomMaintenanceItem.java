...
@Entity
@Table(name = "custom_maintenance_item")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class CustomMaintenanceItem implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "maintenance_common_material_id")
    @JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
    private CustomMaintenanceCommonMaterial maintenanceCommonMaterial;
    ...
    public CustomMaintenanceCommonMaterial getMaintenanceCommonMaterial() { return maintenanceCommonMaterial; }
    public void setMaintenanceCommonMaterial(CustomMaintenanceCommonMaterial maintenanceCommonMaterial) { this.maintenanceCommonMaterial = maintenanceCommonMaterial; }
