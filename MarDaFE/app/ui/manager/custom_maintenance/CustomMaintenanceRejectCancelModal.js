...
export default function CustomMaintenanceRejectCancelModal({
  isOpen,
  onClose,
  onSuccess,
  request,
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await customMaintenanceService.rejectOrCancelRequest(request.id, {
        actionType,
        reason: reason.trim(),
      });
      toast.success(
        actionType === "CANCEL_APPLICATION"
          ? "የጥገና ማመልከቻው በተሳካ ሁኔታ ተሰርዟል"
          : "የጥገና ዳሰሳ ጥናቱ ቴክኒካል መስፈርት ባለማሟላቱ ውድቅ ተደርጓል"
      );
      onSuccess();
      onClose();
    } catch (error) {
    ...
    <div className="fixed inset-0 z-99999 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 pt-8 sm:pt-14 overflow-y-auto">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-bold">
              {isReject ? "የቴክኒክ ዳሰሳ ጥናት ውድቅ ማድረጊያ" : "የጥገና ጥያቄ ስረዛ"}
            </h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="bg-gray-50 dark:bg-gray-750 px-6 py-3 border-b border-gray-100 dark:border-gray-700 text-xs flex justify-between items-center text-gray-600 dark:text-gray-300">
          <span>
            ጥያቄ ቁጥር: <strong className="font-mono">{request.requestNumber}</strong>
          </span>
          <span>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">
                    የጥገና ቴክኒካል መስፈርት አያሟላም / ጥገና ማድረግ አይቻልም
                  </div>
                </div>
              </label>
              ...
              >
                ...
                />
                <div>
                  <div className="font-bold">ጥያቄ ሰርዝ (Cancel Request)</div>
                  <div className="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">
          ...
          <div className="flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-xl text-amber-800 dark:text-amber-200 text-xs">
            ...
            <span>
              ይህ እርምጃ በጥገና ጥያቄው የስራ ሂደት ላይ እንደ ማጠቃለያ (Terminal Exception) የሚመዘገብ ሲሆን
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="ለምሳሌ: በአካባቢው የዋና መስመር ብልሽት ባለመኖሩ እና የውስጥ መስመር ብልሽት በደንበኛው በኩል የሚሰራ በመሆኑ..."
          ...
          <div className="flex justify-end gap-2.5 pt-3 border-t border-gray-100 dark:border-gray-700">
            ...
            >
              ...
              {submitting ? "በማስመዝገብ ላይ..." : isReject ? "ዳሰሳውን ውድቅ አድርግ" : "ጥያቄውን ሰርዝ"}
            </button>
          </div>
        </form>
      </div>
