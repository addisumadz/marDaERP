...
export const API_CONFIG = {
    ...
    BASE_URL_DEV: 'http://192.168.24.31:9092/mardamobileapp/billing',
    BASE_URL_PROD: 'https://your-production-server.com/mardamobileapp/billing',
    // 10.116.212.31
...
export const APP_CONFIG = {
    ...
    VERSION: '1.0.0',
    SYNC_INTERVAL: 900000, // 5 minutes when online
...
export const STORAGE_KEYS = {
    ...
    CUSTOM_URL: '@wbill:custom_url',
    GPS_ACCURACY_LEVEL: '@wbill:gps_accuracy_level',
};
