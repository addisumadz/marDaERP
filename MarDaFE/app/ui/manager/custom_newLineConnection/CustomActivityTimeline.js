...
import { getStatusBadge } from "./CustomNewLineStepper";

export default function CustomActivityTimeline({ requestId }) {
  ...
  const loadLogs = async () => {
    setLoading(true);
    try {
      const data = await customNewLineConnectionService.getApplicationLogs(requestId);
      setLogs(data || []);
    } catch (e) {
