...
const summationGroups = [
  {
    ...
    fields: [
      ...
      { key: "mBillingAdditionalPayment1Value", label: "Service Charge 1" },
      { key: "mBillingAdditionalPayment2Value", label: "Service Charge 2" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "mBillingAdditionalPayment1Wuzif", label: "Wuzif Service Charge 1" },
      { key: "mBillingAdditionalPayment2Wuzif", label: "Wuzif Service Charge 2" },
      { key: "kitat", label: "ክታት" },
