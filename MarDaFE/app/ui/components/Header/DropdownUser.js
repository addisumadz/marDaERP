      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-black dark:text-white">
            {status === "authenticated" ? session.name : defaultuser}
          </span>
          <span className="block text-xs">መረጃ ክፍል</span>
        </span>
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          ...
          {/* <li>
           ...
           {/* Hindeke Technology Plc   Copyright 2024  */}
        <div className="flex items-center justify-between gap-2 py-2 px-4">
          <Link
            href="/ui/profile"
            className="flex items-center gap-2 rounded-md border border-stroke px-3 py-2 text-sm font-medium duration-300 ease-in-out hover:bg-graydark hover:text-white dark:border-strokedark"
          >
            <svg
              className="fill-current"
              width="18"
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M9 8.25C7.20507 8.25 5.75 6.79493 5.75 5C5.75 3.20507 7.20507 1.75 9 1.75C10.7949 1.75 12.25 3.20507 12.25 5C12.25 6.79493 10.7949 8.25 9 8.25Z" fill=""/>
              <path d="M3 15.25V14.5C3 12.2909 4.79086 10.5 7 10.5H11C13.2091 10.5 15 12.2909 15 14.5V15.25H3Z" fill=""/>
            </svg>
            Profile
          </Link>
          <button
            className="flex items-center gap-3.5 py-2 px-3 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
            onClick={async (e) => {
              e.preventDefault();
              signOutHandler();
