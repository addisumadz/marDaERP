...
@Entity
@Table(name = "custom_maintenance_common_material")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class CustomMaintenanceCommonMaterial implements Serializable {
    ...
    public CustomMaintenanceCommonMaterial() {}
