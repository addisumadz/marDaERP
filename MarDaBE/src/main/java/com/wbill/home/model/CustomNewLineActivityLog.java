...
@Entity
@Table(name = "custom_new_line_activity_log")
public class CustomNewLineActivityLog implements Serializable {
    ...
    public CustomNewLineActivityLog() {}

    public CustomNewLineActivityLog(CustomNewLineConnectionRequest request, String action, String fromStatus,
